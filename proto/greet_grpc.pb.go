...
type GreetServiceClient interface {
	SayHello(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HeloResponse, error)
...
func (c *greetServiceClient) SayHello(ctx context.Context, in *NoParam, opts ...grpc.CallOption) (*HeloResponse, error) {
...
func (x *greetServiceSayHelloServerStreamingClient) Recv() (*HeloResponse, error) {
	m := new(HeloResponse)
...
func (x *greetServiceSayHelloClientStreamingClient) Send(m *HeloRequest) error {
...
func (x *greetServiceSayHelloBidirectionalStreamingClient) Send(m *HeloRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirectionalStreamingClient) Recv() (*HeloResponse, error) {
	m := new(HeloResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type GreetServiceServer interface {
	SayHello(context.Context, *NoParam) (*HeloResponse, error)
...
func (UnimplementedGreetServiceServer) SayHello(context.Context, *NoParam) (*HeloResponse, error) {
...
func (x *greetServiceSayHelloServerStreamingServer) Send(m *HeloResponse) error {
...
func (x *greetServiceSayHelloClientStreamingServer) Recv() (*HeloRequest, error) {
	m := new(HeloRequest)
...
func (x *greetServiceSayHelloBidirectionalStreamingServer) Send(m *HeloResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceSayHelloBidirectionalStreamingServer) Recv() (*HeloRequest, error) {
	m := new(HeloRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
